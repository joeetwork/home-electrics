...
export const METRIC_EXPLANATIONS = {
  ...
  batteryPower: "Power flowing to/from battery in kilowatts. Positive = charging, Negative = discharging.",
  ...
  // Grid
  gridPower: "Power flowing to/from grid in kilowatts. Positive = importing, Negative = exporting.",
  ...
  inverterPower: "Power being processed by the inverter in kilowatts.",
  ...
  evPower: "Power being delivered to the electric vehicle in kilowatts.",
