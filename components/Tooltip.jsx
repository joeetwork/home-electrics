...
export const METRIC_EXPLANATIONS = {
  // Solar
  solarPower: "Current power being generated by your solar panels in watts (W).",
  ...
  batteryPower: "Power flowing to/from battery in watts. Positive = charging, Negative = discharging.",
  batteryTemp: "Battery temperature. Optimal range is 15-25°C for lithium batteries.",
  batteryCharge: "Total energy charged into the battery today in kWh.",
  batteryDischarge: "Total energy discharged from the battery today in kWh.",

  // Grid
  gridPower: "Power flowing to/from grid in watts. Positive = importing, Negative = exporting.",
  gridVoltage: "Mains voltage from the grid. UK standard is ~230V.",
  gridFrequency: "Grid frequency. UK standard is 50Hz.",
  gridImport: "Total energy imported from grid today in kWh.",
  gridExport: "Total energy exported to grid today in kWh.",

  // Consumption
  consumptionPower: "Current power being used by your home in watts.",
  consumptionToday: "Total energy consumed by your home today in kWh.",

  // Inverter
  inverterTemp: "Inverter operating temperature. Should stay below 60°C.",
  inverterPower: "Power being processed by the inverter in watts.",
  ...
  evPower: "Power being delivered to the electric vehicle in watts.",
  evEnergy: "Total energy delivered in current charging session in kWh.",
};
